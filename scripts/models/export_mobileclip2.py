...
DEFAULT_OUTPUT_DIR = Path("build/model-export")
...
def create_model(model_name: str, pretrained: str) -> nn.Module:
    ...
    if model_name == "MobileCLIP2-S0" and pretrained == "dfndr2b":
        from huggingface_hub import hf_hub_download
        pretrained = hf_hub_download("timm/MobileCLIP2-S0-OpenCLIP", "open_clip_pytorch_model.bin",
